...
* [internal within valid](#protocol-tests)
* [internal within invalid](#foo-bar-section)
* [internal external valid](test_anchors.html#test-anchor)
* [internal external invalid](test_anchors.html#foo-bar-section)

## Images

### Broken local

Handled with test_images.html (pandoc will detect broken paths).
